...
namespace TP.Site.Models.PrintingAgreementPriceList{

     
    /// <summary>
	/// 印刷协议价格
	/// </summary>
    public class PrintingAgreementPriceListModel : BaseViewModel{
    
        public PrintingAgreementPriceListModel(){
        }
    ...
    public class PrintingAgreementPriceListListModel : BaseListViewModel<BPM_PrintingAgreementPriceList>{
