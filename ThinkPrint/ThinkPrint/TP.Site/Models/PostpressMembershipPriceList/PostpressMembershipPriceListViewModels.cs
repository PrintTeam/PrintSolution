...
namespace TP.Site.Models.PostpressMembershipPriceList{

     
    /// <summary>
	/// 会员后道加工价格
	/// </summary>
    public class PostpressMembershipPriceListModel : BaseViewModel{
    
        public PostpressMembershipPriceListModel(){
        }
    ...
    public class PostpressMembershipPriceListListModel : BaseListViewModel<PMW_PostpressMembershipPriceList>{
