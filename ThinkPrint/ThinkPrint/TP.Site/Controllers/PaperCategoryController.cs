    ...
    public class PaperCategoryController : BaseController {
        ...
        public ActionResult Edit(int id) {
            ...
            PaperCategoryModel model = new PaperCategoryModel {
                Id = PaperCategory.PaperCategoryId,
        ...
        [NonAction]
        private void VerifyModel(PaperCategoryModel model) {
            BOM_PaperCategory PaperCategory = null;
            PaperCategory = m_PaperCategoryService.GetPaperCategory(model.UniqueCode);
            if ((model.IsEdit) && (PaperCategory.PaperCategoryId != model.Id) && (PaperCategory != null)) {
                ModelState.AddModelError("UniqueCode", "参数编码已存在.");
            }
            if ((!model.IsEdit) && (PaperCategory != null)) {
                ModelState.AddModelError("UniqueCode", "参数编码已存在.");
            }
        }
    }
